 ...
 * @version v1.0
 */
@SpringBootTest(classes = SessionTest.SessionApplication.class, webEnvironment = SpringBootTest.WebEnvironment.RANDOM_PORT)
@TestPropertySource(properties = "spring.config.location=classpath:spring-session.yml")
...
public class SessionTest {
    ...
    public void testSession() throws Exception {
        ...
        Assertions.assertThat(redisOperationsSessionRepository.findById(cookieKey))
                .isNotNull();
        // 请求获取session
