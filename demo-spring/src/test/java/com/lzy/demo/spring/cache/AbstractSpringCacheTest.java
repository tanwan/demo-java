/*
 * Created by lzy on 2019-06-03 15:06.
 */
...
@TestPropertySource(properties = "spring.config.location=classpath:spring-cache.yml")
@Import(CacheAutoConfiguration.class)
@SpringJUnitConfig(initializers = ConfigFileApplicationContextInitializer.class, classes = {CacheServiceImpl.class})
