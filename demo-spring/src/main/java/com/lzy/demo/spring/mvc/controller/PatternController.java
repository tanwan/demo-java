/*
 * Created by LZY on 2017/10/2 17:53.
 */
...
public class PatternController {
    ...
    /**
     * <code>@PathVariable</code>把最后一个点后面的字符当做后缀
     * /suffix/variable pathVariable = variable
     * /suffix/variable.com pathVariable = variable
     * /suffix/variable.pdf  pathVariable = variable
     * /suffix/variable.pdf.com pathVariable的值是pathVariable = variable.pdf
     *
     * @param pathVariable the path variable
     * @return the string
     */
    @GetMapping("/suffix/{pathVariable}")
    public String suffixPathVariable(@PathVariable String pathVariable) {
