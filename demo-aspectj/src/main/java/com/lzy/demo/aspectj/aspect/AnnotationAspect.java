...
import com.lzy.demo.aspectj.bean.AspectSample;
...
public class AnnotationAspect {
     ...
     * 方法需要有@SampleAnnotation注解,第一个参数也需要有@SampleAnnotation注解
     *
     * @param jp the jp
     */
    @Before("execution(void parameterAnnotation(@com.lzy.demo.aspectj.annotation.SampleAnnotation (*),*))")
    ...
    /**
     * 类型需要注解
     * 返回值的类需要有@SampleAnnotation注解,第一个参数的类也需要有@SampleAnnotation注解
     *
     * @param jp the jp
     */
    @After("execution((@com.lzy.demo.aspectj.annotation.SampleAnnotation *) typeAnnotation((@com.lzy.demo.aspectj.annotation.SampleAnnotation *),*))")
    public void typeAnnotation(JoinPoint jp) {
        System.out.println("after: " + jp.getSignature());
    }

    /**
     * 连接点为void atWithin(),并且该连接点所属的类需要有@SampleAnnotation注解
     *
     * @param pjp the pjp
     * @throws Throwable the throwable
     */
    @Around("execution(void atWithin()) && @within(com.lzy.demo.aspectj.annotation.SampleAnnotation)")
    ...
    /**
     * 接入点为void thiz(),并且接入点的this对象属于AspectSample
     *
     * @param pjp the pjp
     * @throws Throwable the throwable
     */
    @Around("execution(void thiz())&&this(com.lzy.demo.aspectj.bean.AspectSample)")
    ...
    /**
     * 接入点为void thisArgs(),并且接入点的this对象属于AspectSample,获取this的参数
     *
     * @param bean the bean
     * @param pjp  the pjp
     */
    @Before("execution(void thisArgs())&&this(com.lzy.demo.aspectj.bean.AspectSample)&&this(bean)")
    public void thisArgs(AspectSample bean, JoinPoint pjp) {
        System.out.println("this before: " + pjp.getSignature());
    ...
    /**
     * 接入点为void target(),并且接入点的target对象属于AspectSample
     * aspectj可以使用call,spring aop不支持
     *
     * @param pjp the pjp
     * @throws Throwable the throwable
     */
    @Around("call(void target())&&target(com.lzy.demo.aspectj.bean.AspectSample)")
    ...
    /**
     * 接入点为void atTarget(),并且接入点的target对象需要有@SampleAnnotation注解
     * aspectj可以使用call,spring aop不支持
     *
     * @param pjp the pjp
     * @throws Throwable the throwable
     */
    @Around("call(void atTarget())&&@target(com.lzy.demo.aspectj.annotation.SampleAnnotation)")
     ...
     * @throws Throwable the throwable
     */
    @Around("execution(void atArgs(..)) && @args(com.lzy.demo.aspectj.annotation.SampleAnnotation,*,*)")
    ...
    /**
     * 方法需要有@SampleAnnotation注解(如果类上有@SampleAnnotation注解,则这个类的clinit方法也会被增强)
     * 同execution(@com.lzy.demo.aspectj.annotation.SampleAnnotation * *())一样
     * 如果不需要获取注解的值,则使用@annotation(com.lzy.demo.aspectj.annotation.SampleAnnotation)
     *
    ...
    public void atAnnotation(SampleAnnotation annotation, ProceedingJoinPoint pjp) throws Throwable {
     ...
     * 通知的顺序
     */
    @Pointcut("execution(void *..AspectSampleBean1.order())")
