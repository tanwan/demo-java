...
public class ResourcePathDemo {
    ...
    public static void main(String[] args) throws Exception {
        ...
        URL url = ResourcePathDemo.class.getClassLoader().getResource("java/lang/String.class");
        System.out.println(url);
        System.out.println("----------------getResources------------------");
        //获取资源的顺序是按classpath的顺序,spring-boot打的包的classpath只有自己本身,它获取的资源是嵌套jar,顺序是嵌套jar的包名hash值,排序
        Enumeration<URL> urls = ResourcePathDemo.class.getClassLoader().getResources("META-INF/MANIFEST.MF");
