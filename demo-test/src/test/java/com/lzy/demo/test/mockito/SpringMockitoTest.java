...
public class SpringMockitoTest {
    ...
    public void testMockBean(ApplicationContext applicationContext) {
        ...
        assertThat(dependenceServiceFromSpring.dependenceMethod(simpleBean))
                .extracting(SimpleBean::getBody).isEqualTo("mock");


        assertThat(dependenceService.dependenceMethod(simpleBean))
                .extracting(SimpleBean::getBody).isEqualTo("mock");

        assertThat(simpleService.simpleMethod(simpleBean))
                .extracting(SimpleBean::getBody).isEqualTo("mock");
