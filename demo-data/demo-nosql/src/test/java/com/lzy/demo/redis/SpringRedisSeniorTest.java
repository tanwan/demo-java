/*
 * Created by lzy on 2019/9/27 3:21 PM.
 */
...
@SpringJUnitConfig(initializers = ConfigFileApplicationContextInitializer.class, classes = {RedisAutoConfiguration.class, SubscribingConfig.class})
...
public class SpringRedisSeniorTest {
    ...
    public void testPipelineUseSessionCallback() {
        //pipeLine操作的返回值
        List list = stringRedisTemplate.executePipelined(new SessionCallback<String>() {
            @Override
