/*
 * Created by lzy on 2020/5/27 2:33 PM.
 */
...
public class ShardingTest {
    ...
    private static final String JDBC_URL_0 = "jdbc:mysql://localhost:3306/demo";
    private static final String JDBC_URL_1 = "jdbc:mysql://localhost:3307/demo";
    ...
    private Map<String, DataSource> dataSourceMap() {
        ...
        dataSource0.setDriverClassName(DRIVER_NAME);
        dataSource0.setJdbcUrl(JDBC_URL_0);
        ...
        dataSource1.setJdbcUrl(JDBC_URL_1);
