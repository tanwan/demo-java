...
public interface ISimpleMybatis extends Serializable {
    ...
    /**
     * Load data from another generated Record/POJO implementing the common interface ISimpleMybatis
     */
    public void from(ISimpleMybatis from);

    /**
     * Copy data into another generated Record/POJO implementing the common interface ISimpleMybatis
     */
