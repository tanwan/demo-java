...
public class ThriftMessage implements org.apache.thrift.TBase<ThriftMessage, ThriftMessage._Fields>, java.io.Serializable, Cloneable, Comparable<ThriftMessage> {
  ...
  public int compareTo(ThriftMessage other) {
    ...
    lastComparison = Boolean.compare(isSetInteger(), other.isSetInteger());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetInteger()) {
    ...
    lastComparison = Boolean.compare(isSetDou(), other.isSetDou());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetDou()) {
    ...
    lastComparison = Boolean.compare(isSetStringList(), other.isSetStringList());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetStringList()) {
    ...
    lastComparison = Boolean.compare(isSetThriftMessageSet(), other.isSetThriftMessageSet());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetThriftMessageSet()) {
    ...
    lastComparison = Boolean.compare(isSetThriftMessageMap(), other.isSetThriftMessageMap());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetThriftMessageMap()) {
  ...
  private static class ThriftMessageTupleScheme extends org.apache.thrift.scheme.TupleScheme<ThriftMessage> {
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, ThriftMessage struct) throws org.apache.thrift.TException {
      ...
      if (incoming.get(3)) {
        {
          org.apache.thrift.protocol.TSet _set19 = iprot.readSetBegin(org.apache.thrift.protocol.TType.STRUCT);
